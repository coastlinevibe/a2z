...
const VideoPlayerPro: React.FC<VideoPlayerProProps> = ({ src, className }) => {
  ...
  return (
    <motion.div
      ref={containerRef}
      className={cn("relative w-full max-w-5xl mx-auto overflow-hidden rounded-xl", className)}
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                {/* Play / Pause / Restart */}
                <Button variant="ghost" size="sm" className="text-white hover:bg-white/20 w-10 h-10" onClick={togglePlay}>
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-32 bg-black/80 backdrop-blur-sm p-2">
                    <Slider
                      value={[volume * 100]}  
